...
import MdxCard from './mdx-card.astro'
...
export const MdxComponents = {
  ...
  ul: ({ className, ...props }: Props) => <ul className={cn('my-6 ml-6 list-disc', className)} {...props} />,
  ol: ({ className, ...props }: Props) => <ol className={cn('my-6 ml-6 list-decimal', className)} {...props} />,
  li: ({ className, ...props }: Props) => <li className={cn('mt-2', className)} {...props} />,
